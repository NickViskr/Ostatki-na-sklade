...
module.exports = {
  ...
  CHINA_TARIFF_HEADERS: context.CHINA_TARIFF_HEADERS,
  CHINA_FORECAST_HEADERS: context.CHINA_FORECAST_HEADERS,
  chinaDaysBetween: (...args) => context.chinaDaysBetween(...args),
  chinaTodayText: (...args) => context.chinaTodayText(...args),
  chinaMedian: (...args) => context.chinaMedian(...args),
  chinaTariffFromFreight: (...args) => context.chinaTariffFromFreight(...args),
  chinaTariffList: (...args) => context.chinaTariffList(...args),
  chinaTariffPick: (...args) => context.chinaTariffPick(...args),
  chinaBoxDirectory: (...args) => context.chinaBoxDirectory(...args),
  chinaPackagingFactors: (...args) => context.chinaPackagingFactors(...args),
  chinaTariffSummary: (...args) => context.chinaTariffSummary(...args),
  chinaForecastCalc: (...args) => context.chinaForecastCalc(...args),
  chinaForecastContext: (...args) => context.chinaForecastContext(...args),
  calcChinaForecast: (...args) => context.calcChinaForecast(...args),
  saveChinaForecast: (...args) => context.saveChinaForecast(...args),
  deleteChinaForecast: (...args) => context.deleteChinaForecast(...args),
  chinaForecastVsFact: (...args) => context.chinaForecastVsFact(...args),
